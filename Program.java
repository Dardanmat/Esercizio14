...
//        v2.add(new Bagaglio("Batistuta Mario",27));
        ...
        Bagaglio b4 = new Bagaglio(50, "Nirushan Gopalakrishnan");
        Bagaglio b5 = new Bagaglio(90, "Nirushan Gopalakrishnan");
        Bagaglio b6 = new Bagaglio(30, "Dardan Berisha");
        Bagaglio b7 = new Bagaglio(250, "Nirushan Gopalakrishnan");
        ...
        for(Bagaglio x: bag){
            System.out.println("\nNome: "+x.getNomePropietario() + " \n- Peso: " + x.getPeso() + " - Tariffa da pagare: "+ x.getTariffaExtra() + "€");
        }
